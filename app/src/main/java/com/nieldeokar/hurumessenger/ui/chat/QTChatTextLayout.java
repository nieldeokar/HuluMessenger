...
public class QTChatTextLayout extends ConstraintLayout {
    ...
    public QTChatTextLayout(Context context) {
        super(context);
    }

    public QTChatTextLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            viewPartMain = (TextView) this.findViewById(a.getResourceId(R.styleable.MessageTextStyle_viewPartMain, -1));
